        ...
        setContent {
            HappyBirthdayTheme {
                ...
                Surface(
                    ...
                    GreetingImage(name = stringResource(id = R.string.name), from = stringResource(id = R.string.from))
                }
            }
        }
    }
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        GreetingImage(stringResource(id = R.string.name), stringResource(id = R.string.from))
    }
}